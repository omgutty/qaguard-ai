// Requirement Agent — deterministic mock implementation (Phase 1).
// Preserved for reference/testing. The production agent (requirement-agent.ts)
// now calls the real LLM; there is NO silent fallback to this mock.
...
export function analyzeRequirementMock(
  requirement: Requirement
): RequirementAnalysis {
